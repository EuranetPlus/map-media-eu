export const config = {
	mapTitle: 'media-eu', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-media-eu.vercel.app', // The url provided when deploying the map on Vercel
